...
"campfire" is a match-3 game, running on Pygame, using original textures and icons, also equiping lo-fi genre background songs. 
...
"campfire" meets you with a cosy main menu and main theme of the game on the background.
...
There are 2 different game modes, replacing each other every single level.

1) Match the required type chips to complete the level
2) Match the chips to open all the cells to complete the level

This game contains 8 unique level patterns.
...
Have fun!
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
campfire, Anton Vereschagin (Dream Boy), 2021
